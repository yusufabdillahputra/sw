...
if (isset($_POST['kata_pencarian'])) {
    ...
    ?>
    <table id="e_dg_cari_barang" style="width:auto;height:auto">
        <thead>
        <tr>
        ...
        $(document).ready(function() {
            ...
            dg.datagrid({
                ...
                onClickRow: function(rowIndex, rowData) {
                    let cek_select = detectSelection(rowData.id_barang);
                    if (cek_select == false) {
            ...
            function detectSelection(id) {
                let row_in_select = dg.datagrid('getSelections');
                for (let x in row_in_select) {
